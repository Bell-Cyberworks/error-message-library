...
// docs/error-code-schema.md ("Response shape (sketch)") for the field contract. This page
// only renders `header`, `code`, and `friendlyMessage`; the rest of the fields are part of
// the documented contract but out of scope for this display pass — see error-ui/README.md.
...
const FALLBACK_HEADER = "We couldn't load this error";
...
function normalizeParams(rawParams: RawSearchParams): ErrorPageParams {
  return {
...
async function lookupErrorDetails(params: ErrorPageParams): Promise<LookupResponse | null> {
